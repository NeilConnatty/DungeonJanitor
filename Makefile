...
BIN=main
OBJ=$(BIN).o common.o world.o camera.o dungeon.o floor.o gameobject.o janitor.o door.o room.o roomtextparser.o wall.o hero.o boss.o $(CURDIR)/src/Cleanable/puddle.o ValueIteration.o $(CURDIR)/src/Cleanable/artifact.o pathfinder.o pathfindernode.o gameover.o
