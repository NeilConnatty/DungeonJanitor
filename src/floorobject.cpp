...
bool FloorObject::init()
{
  return init({ 0.f, 0.f });
}

bool FloorObject::init(vec2 position)
{
...
void FloorObject::draw_current(const mat3& projection, const mat3& current_transform)
{
  // Setting shaders
